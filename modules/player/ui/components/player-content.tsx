...
import PlayerMediaItem from "@/components/common/PlayerMediaItem";
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 pr-4 bg-neutral-900 rounded-md">
      <div className="flex w-full justify-start">
        <div className="flex items-center gap-x-4">
          <PlayerMediaItem data={song} />
        </div>
      </div>

      <div className="flex md:hidden w-full justify-end items-center gap-x-6 pr-4">
        <AiFillStepBackward
